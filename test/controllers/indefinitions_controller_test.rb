...
class IndefinitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create indefinition" do
    assert_difference('Indefinition.count') do
      post indefinitions_url, params: { indefinition: { description: @indefinition.description, nom: @indefinition.nom, string: @indefinition.string } }
    end
  ...
  test "should update indefinition" do
    patch indefinition_url(@indefinition), params: { indefinition: { description: @indefinition.description, nom: @indefinition.nom, string: @indefinition.string } }
